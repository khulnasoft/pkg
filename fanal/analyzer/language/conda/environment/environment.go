...
import (
	...
	"go.khulnasoft.com/pkg/dependency/parser/conda/environment"
...
func findLicenseFromEnvDir(pkg types.Package, prefix string) ([]string, error) {
	...
	for _, entry := range entries {
		...
		if matched {
			...
			// cf. https://go.khulnasoft.com/tunnel/blob/c3192f061d7e84eaf38df8df7c879dc00b4ca137/pkg/dependency/parser/conda/meta/parse.go#L39-L45
