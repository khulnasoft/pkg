...
import (
	...
	"go.khulnasoft.com/pkg/dependency"
	"go.khulnasoft.com/pkg/dependency/parser/nodejs/packagejson"
	"go.khulnasoft.com/pkg/dependency/parser/nodejs/yarn"
	"go.khulnasoft.com/pkg/detector/library/compare/npm"
	"go.khulnasoft.com/pkg/fanal/analyzer"
	"go.khulnasoft.com/pkg/fanal/analyzer/language"
	"go.khulnasoft.com/pkg/fanal/analyzer/language/nodejs/license"
	"go.khulnasoft.com/pkg/fanal/types"
	"go.khulnasoft.com/pkg/log"
	"go.khulnasoft.com/pkg/utils/fsutils"
	xio "go.khulnasoft.com/pkg/x/io"
)
