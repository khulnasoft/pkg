						...
						Packages: types.Packages{
							{
								...
								DependsOn: []string{
									...
									"github.com/khulnasoft-lab/go-version@v1.0.1",
							...
							{
								ID:           "github.com/khulnasoft-lab/go-dep-parser@v1.0.0",
								Name:         "github.com/khulnasoft-lab/go-dep-parser",
								Version:      "v1.0.0",
								Relationship: types.RelationshipDirect,
								ExternalReferences: []types.ExternalRef{
							...
							{
								ID:           "github.com/khulnasoft-lab/go-version@v1.0.1",
						...
						Packages: types.Packages{
							{
								...
								Relationship: types.RelationshipRoot,
								DependsOn: []string{
									"github.com/khulnasoft-lab/go-dep-parser@v0.0.0-20230219131432-590b1dfb6edd",
								},
								ExternalReferences: []types.ExternalRef{
									{
										Type: types.RefVCS,
