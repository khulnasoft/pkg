...
import (
	...
	goversion "github.com/khulnasoft-lab/go-version/pkg/version"
	"go.khulnasoft.com/pkg/dependency/parser/python/packaging"
	"go.khulnasoft.com/pkg/dependency/parser/python/pip"
	...
	"go.khulnasoft.com/pkg/utils/fsutils"
)
...
func (a pipLibraryAnalyzer) pkgLicense(pkgName, pkgVer, spDir string) []string {
	...
	// cf. https://go.khulnasoft.com/tunnel/blob/e66dbb935764908f0b2b9a55cbfe6c107f101a31/pkg/dependency/parser/python/packaging/parse.go#L86-L92
