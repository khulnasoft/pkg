...
func TestPackageURL_Match(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "same purl",
			constraint: "pkg:golang/go.khulnasoft.com/tunnel@v0.49.0",
			target:     "pkg:golang/go.khulnasoft.com/tunnel@v0.49.0",
			want:       true,
		},
		{
			name:       "different type",
			constraint: "pkg:golang/go.khulnasoft.com/tunnel@v0.49.0",
			target:     "pkg:maven/go.khulnasoft.com/tunnel@0.49.0",
			want:       false,
		},
		{
		...
		},
		{
			name:       "different name",
			constraint: "pkg:golang/go.khulnasoft.com/tunnel@v0.49.0",
			target:     "pkg:golang/github.com/khulnasoft/tracker@v0.49.0",
			want:       false,
		},
		{
			name:       "different version",
			constraint: "pkg:golang/go.khulnasoft.com/tunnel@v0.49.0",
			target:     "pkg:golang/go.khulnasoft.com/tunnel@v0.49.1",
			want:       false,
		},
		{
			name:       "version wildcard",
			constraint: "pkg:golang/go.khulnasoft.com/tunnel",
			target:     "pkg:golang/go.khulnasoft.com/tunnel@v0.50.0",
			want:       true,
		},
		{
