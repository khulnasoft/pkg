...
const (
	...
	builtinRulesUrl = "https://go.khulnasoft.com/tunnel/blob/main/pkg/fanal/secret/builtin-rules.go" // list all secrets
)
...
func (sw *SarifWriter) Write(ctx context.Context, report types.Report) error {
	...
	sw.run = sarif.NewRunWithInformationURI("Tunnel", "https://go.khulnasoft.com/tunnel")
...
func clearURI(s string) string {
	...
	case strings.HasPrefix(s, "git@github.com:"):
		...
		// cf. https://go.khulnasoft.com/tunnel/issues/7897
