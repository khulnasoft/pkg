...
import (
	...
	k8sArtifacts "go.khulnasoft.com/tunnel-kubernetes/pkg/artifacts"
	"go.khulnasoft.com/tunnel-kubernetes/pkg/k8s"
	cmd "go.khulnasoft.com/pkg/commands/artifact"
	"go.khulnasoft.com/pkg/commands/operation"
	cr "go.khulnasoft.com/pkg/compliance/report"
	"go.khulnasoft.com/pkg/flag"
	k8sRep "go.khulnasoft.com/pkg/k8s"
	"go.khulnasoft.com/pkg/k8s/report"
	"go.khulnasoft.com/pkg/k8s/scanner"
