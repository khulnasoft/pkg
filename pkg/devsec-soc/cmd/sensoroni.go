...
import (
  ...
  agentModules "github.com/khulnasoft/devsec-soc/agent/modules"
  "github.com/khulnasoft/devsec-soc/config"
  "github.com/khulnasoft/devsec-soc/module"
  "github.com/khulnasoft/devsec-soc/server"
  serverModules "github.com/khulnasoft/devsec-soc/server/modules"
  "os"
  "os/signal"
  "syscall"
  "time"
