		...
		Annotations: []*doghouse.Annotation{
			...
			},
			{
				Diagnostic: &rdf.Diagnostic{
					...
					Code: &rdf.Code{Value: "CODE14", Url: "https://github.com/khulnasoft#CODE14"},
				},
			},
			{
				Path:       "sample.new.txt",
		...
		if len(annotations) == 0 {
			...
			wantAnnotations := []*github.CheckRunAnnotation{
				...
				},
				{
					...
					Title:           github.String("[haya14busa-linter] sample.new.txt#L2 <CODE14>(https://github.com/khulnasoft#CODE14)"),
				},
				{
					Path:            github.String("sample.new.txt"),
					StartLine:       github.Int(2),
