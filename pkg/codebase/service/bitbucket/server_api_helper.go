...
func (h *ServerAPIHelper) BuildAnnotations(comments []*codebase.Comment) insights.AnnotationsList {
...
func (h *ServerAPIHelper) buildAnnotation(comment *codebase.Comment) insights.Annotation {
