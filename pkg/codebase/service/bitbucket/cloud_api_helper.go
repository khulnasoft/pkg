...
import (
	...
	bbapi "github.com/khulnasoft/codebase/go-bitbucket"
...
func (c *CloudAPIHelper) BuildAnnotations(comments []*codebase.Comment) []bbapi.ReportAnnotation {
...
func (c *CloudAPIHelper) buildAnnotation(comment *codebase.Comment) bbapi.ReportAnnotation {
