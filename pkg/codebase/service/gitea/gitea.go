...
var (
	_ codebase.CommentService = &PullRequest{}
	_ codebase.DiffService    = &PullRequest{}
)
...
func buildReviewComment(c *codebase.Comment, body string) gitea.CreatePullReviewComment {
...
// it's start line.
func giteaCommentLine(c *codebase.Comment) int {
