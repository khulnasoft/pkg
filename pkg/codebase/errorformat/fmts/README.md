...
```
go get -u github.com/khulnasoft/errorformat/cmd/errorformat
```

### 2) Write errorformat for the target output
- errorformat doc: http://vimdoc.sourceforge.net/htmldoc/quickfix.html#errorformat

Note that https://github.com/khulnasoft/errorformat doesn't support Vim regex, and `efm-%>` feature (currently).
...
Required fields are self descriptive. See https://godoc.org/github.com/khulnasoft/errorformat/fmts#Fmt
