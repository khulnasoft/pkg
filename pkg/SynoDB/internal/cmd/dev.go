...
var devCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		tempDir, err := os.MkdirTemp("", "*synodbdev")
		if err != nil {
		...
		if err != nil {
			fmt.Fprintf(os.Stderr, "%s.\no install it, follow the instructions at %s\nAlso make sure %s is on your PATH\n", internal.Warn("Could not start libsql-server"),
				internal.Emph("https://github.com/khulnasoft/libsql/blob/main/libsql-server/docs/BUILD-RUN.md"),
				internal.Emph("sqld"))
			return err
		}
