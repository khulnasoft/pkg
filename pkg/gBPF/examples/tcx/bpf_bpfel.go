...
type bpfMapSpecs struct {
	EgressPktCount  *gbpf.MapSpec `gbpf:"egress_pkt_count"`
	IngressPktCount *gbpf.MapSpec `gbpf:"ingress_pkt_count"`
}
...
// It can be passed to loadBpfObjects or gbpf.CollectionSpec.LoadAndAssign.
type bpfMaps struct {
	EgressPktCount  *gbpf.Map `gbpf:"egress_pkt_count"`
	IngressPktCount *gbpf.Map `gbpf:"ingress_pkt_count"`
}
