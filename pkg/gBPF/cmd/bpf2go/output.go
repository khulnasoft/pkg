...
func collectFromSpec(spec *gbpf.CollectionSpec, cTypes []string, skipGlobalTypes bool) (maps, programs []string, types []btf.Type, _ error) {
...
func collectMapTypes(maps map[string]*gbpf.MapSpec) []btf.Type {
	var result []btf.Type
	for _, m := range maps {
