...
type NetscaleServer struct{ Client capnp.Client }

// NetscaleServer_TypeID is the unique identifier for the type NetscaleServer.
const NetscaleServer_TypeID = 0xf548cef9dea2a4a1

func (c NetscaleServer) RegisterUdpSession(ctx context.Context, params func(SessionManager_registerUdpSession_Params) error, opts ...capnp.CallOption) SessionManager_registerUdpSession_Results_Promise {
	if c.Client == nil {
		return SessionManager_registerUdpSession_Results_Promise{Pipeline: capnp.NewPipeline(capnp.ErrorAnswer(capnp.ErrNullClient))}
	}
	call := &capnp.Call{
...
func (c NetscaleServer) UnregisterUdpSession(ctx context.Context, params func(SessionManager_unregisterUdpSession_Params) error, opts ...capnp.CallOption) SessionManager_unregisterUdpSession_Results_Promise {
	if c.Client == nil {
		return SessionManager_unregisterUdpSession_Results_Promise{Pipeline: capnp.NewPipeline(capnp.ErrorAnswer(capnp.ErrNullClient))}
	}
	call := &capnp.Call{
...
func (c NetscaleServer) UpdateConfiguration(ctx context.Context, params func(ConfigurationManager_updateConfiguration_Params) error, opts ...capnp.CallOption) ConfigurationManager_updateConfiguration_Results_Promise {
	if c.Client == nil {
		return ConfigurationManager_updateConfiguration_Results_Promise{Pipeline: capnp.NewPipeline(capnp.ErrorAnswer(capnp.ErrNullClient))}
	}
	call := &capnp.Call{
...
type NetscaleServer_Server interface {
	RegisterUdpSession(SessionManager_registerUdpSession) error
...
func NetscaleServer_ServerToClient(s NetscaleServer_Server) NetscaleServer {
	c, _ := s.(server.Closer)
	return NetscaleServer{Client: server.New(NetscaleServer_Methods(nil, s), c)}
}

func NetscaleServer_Methods(methods []server.Method, s NetscaleServer_Server) []server.Method {
	if cap(methods) == 0 {
		methods = make([]server.Method, 0, 3)
	}
