...
import (
	...
	"github.com/khulnasoft/netscale/proxy"
...
type Orchestrator struct {
	...
	proxy atomic.Value
	// Set of internal ingress rules defined at netscale startup (separate from user-defined ingress rules)
...
func (o *Orchestrator) updateIngress(ingressRules ingress.Ingress, warpRouting ingress.WarpRoutingConfig) error {
	select {
	case <-o.shutdownC:
		return fmt.Errorf("netscale already shutdown")
	default:
	}
