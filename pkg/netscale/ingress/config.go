...
// OriginRequestConfig configures how Netscale sends requests to origin
// services.
...
// SetConfig gets config for the requests that netscale sends to origins.
...
//  3. Defaults chosen by the netscale team
