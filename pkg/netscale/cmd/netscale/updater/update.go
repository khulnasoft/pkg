...
const (
	...
	noUpdateInShellMessage        = "netscale will not automatically update when run from the shell. To enable auto-updates, run netscale as a service: https://developers.cloudflare.com/cloudflare-one/connections/connect-apps/run-tunnel/as-a-service/"
