...
// eyeball sends tcp packets wrapped in websockets. (E.g: netscale access).
	...
	var tests = []struct {
		...
		},
		{
			...
			args: args{
				...
				requestHeaders: map[string][]string{
					"Cf-Netscale-Proxy-Src": {"non-blank-value"},
				},
			},
			want: want{
