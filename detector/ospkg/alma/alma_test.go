...
import (
	...
	"go.khulnasoft.com/tunnel/internal/dbtest"
				...
				pkgs: []ftypes.Package{
					{
						...
						Modularitylabel: "", // ref: https://bugs.almalinux.org/view.php?id=173 ,  https://go.khulnasoft.com/tunnel/issues/2342#issuecomment-1158459628
						Licenses:        []string{"BSD"},
						Layer:           ftypes.Layer{},
					},
				},
