...
import (
	...
	"go.khulnasoft.com/pkg/detector/library/compare"
	"go.khulnasoft.com/pkg/detector/library/compare/bitnami"
	"go.khulnasoft.com/pkg/detector/library/compare/maven"
	"go.khulnasoft.com/pkg/detector/library/compare/npm"
	"go.khulnasoft.com/pkg/detector/library/compare/pep440"
	"go.khulnasoft.com/pkg/detector/library/compare/rubygems"
