...
import (
	...
	"go.khulnasoft.com/pkg/fanal/artifact"
...
var (
	...
	goModulePackage = ftypes.Package{
		ID:           "github.com/khulnasoft-lab/go-module@v1.0.0",
		Name:         "github.com/khulnasoft-lab/go-module",
		Version:      "v1.0.0",
	...
	goDirectPackage1 = ftypes.Package{
		ID:           "github.com/khulnasoft-lab/go-direct1@v2.0.0",
		Name:         "github.com/khulnasoft-lab/go-direct1",
		Version:      "v2.0.0",
	...
	goDirectPackage2 = ftypes.Package{
		ID:           "github.com/khulnasoft-lab/go-direct2@v3.0.0",
		Name:         "github.com/khulnasoft-lab/go-direct2",
		Version:      "v3.0.0",
		Relationship: ftypes.RelationshipDirect,
		Identifier: ftypes.PkgIdentifier{
			UID: "05",
	...
	goTransitivePackage = ftypes.Package{
		ID:           "github.com/khulnasoft-lab/go-transitive@v4.0.0",
		Name:         "github.com/khulnasoft-lab/go-transitive",
		Version:      "v4.0.0",
...
func goSinglePathResult(result types.Result) types.Result {
	...
	// - pkg:golang/github.com/khulnasoft-lab/go-module@v1.0.0
	//     - pkg:golang/github.com/khulnasoft-lab/go-direct1@v2.0.0
	//         - pkg:golang/github.com/khulnasoft-lab/go-transitive@v4.0.0
...
func goMultiPathResult(result types.Result) types.Result {
	...
	// - pkg:golang/github.com/khulnasoft-lab/go-module@v2.0.0
	//     - pkg:golang/github.com/khulnasoft-lab/go-direct1@v3.0.0
	//         - pkg:golang/github.com/khulnasoft-lab/go-transitive@v5.0.0
	//     - pkg:golang/github.com/khulnasoft-lab/go-direct2@v4.0.0
	//         - pkg:golang/github.com/khulnasoft-lab/go-transitive@v5.0.0
	goModule := clonePackage(goModulePackage)
	goDirect1 := clonePackage(goDirectPackage1)
