...
import (
	...
	"go.khulnasoft.com/pkg/clock"
	"go.khulnasoft.com/pkg/fanal/artifact"
	aimage "go.khulnasoft.com/pkg/fanal/artifact/image"
	flocal "go.khulnasoft.com/pkg/fanal/artifact/local"
	"go.khulnasoft.com/pkg/fanal/artifact/repo"
	"go.khulnasoft.com/pkg/fanal/artifact/sbom"
	"go.khulnasoft.com/pkg/fanal/artifact/vm"
	"go.khulnasoft.com/pkg/fanal/image"
	ftypes "go.khulnasoft.com/pkg/fanal/types"
	"go.khulnasoft.com/pkg/log"
	"go.khulnasoft.com/pkg/report"
