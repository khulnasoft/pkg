...
func TestSplitPackageSubdirRaw(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			source:         "git::https://github.com/khulnasoft-lab/terraform-modules.git//modules/ecs-service?ref=v0.1.0",
			expectedPkg:    "git::https://github.com/khulnasoft-lab/terraform-modules.git?ref=v0.1.0",
			expectedSubdir: "modules/ecs-service",
		},
		{
			name:           "address with scheme",
			source:         "git::https://github.com/khulnasoft-lab/terraform-modules.git//modules/ecs-service",
			expectedPkg:    "git::https://github.com/khulnasoft-lab/terraform-modules.git",
			expectedSubdir: "modules/ecs-service",
		},
		{
