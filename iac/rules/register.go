...
import (
	...
	"go.khulnasoft.com/tunnel-checks/pkg/specs"
	"go.khulnasoft.com/pkg/iac/framework"
	"go.khulnasoft.com/pkg/iac/scan"
	dftypes "go.khulnasoft.com/pkg/iac/types"
	ruleTypes "go.khulnasoft.com/pkg/iac/types/rules"
)
