...
import (
	...
	"go.khulnasoft.com/pkg/commands/operation"
	"go.khulnasoft.com/pkg/db"
	"go.khulnasoft.com/pkg/fanal/analyzer"
	"go.khulnasoft.com/pkg/fanal/artifact"
	ftypes "go.khulnasoft.com/pkg/fanal/types"
	"go.khulnasoft.com/pkg/fanal/walker"
	"go.khulnasoft.com/pkg/flag"
	"go.khulnasoft.com/pkg/iac/rego"
	"go.khulnasoft.com/pkg/javadb"
	"go.khulnasoft.com/pkg/log"
	"go.khulnasoft.com/pkg/misconf"
	"go.khulnasoft.com/pkg/module"
	pkgReport "go.khulnasoft.com/pkg/report"
	"go.khulnasoft.com/pkg/result"
	"go.khulnasoft.com/pkg/rpc/client"
	"go.khulnasoft.com/pkg/scanner"
	"go.khulnasoft.com/pkg/types"
	"go.khulnasoft.com/pkg/version/doc"
)
