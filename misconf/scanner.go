...
import (
	...
	"go.khulnasoft.com/pkg/iac/scan"
	"go.khulnasoft.com/pkg/iac/scanners"
	"go.khulnasoft.com/pkg/iac/scanners/azure/arm"
	cfscanner "go.khulnasoft.com/pkg/iac/scanners/cloudformation"
	cfparser "go.khulnasoft.com/pkg/iac/scanners/cloudformation/parser"
	dfscanner "go.khulnasoft.com/pkg/iac/scanners/dockerfile"
	"go.khulnasoft.com/pkg/iac/scanners/generic"
	"go.khulnasoft.com/pkg/iac/scanners/helm"
	k8sscanner "go.khulnasoft.com/pkg/iac/scanners/kubernetes"
	"go.khulnasoft.com/pkg/iac/scanners/options"
	"go.khulnasoft.com/pkg/iac/scanners/terraform"
	tfprawscanner "go.khulnasoft.com/pkg/iac/scanners/terraformplan/snapshot"
	tfpjsonscanner "go.khulnasoft.com/pkg/iac/scanners/terraformplan/tfjson"
	"go.khulnasoft.com/pkg/log"
	"go.khulnasoft.com/pkg/mapfs"
