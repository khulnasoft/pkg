...
import (
	...
	"go.khulnasoft.com/pkg/dependency/parser/java/pom"
...
func TestPom_Parse(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			// Save DependsOn for each package - https://github.com/khulnasoft-lab/go-dep-parser/pull/243#discussion_r1303904548
