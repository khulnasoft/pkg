...
var (
	...
	GoModNormal = []ftypes.Package{
		...
		{
			ID:           "github.com/khulnasoft-lab/go-version@v0.0.0-20240603093900-cf8a8d29271d",
			...
			ExternalReferences: []ftypes.ExternalRef{
				{
					Type: ftypes.RefVCS,
					URL:  "https://github.com/khulnasoft-lab/go-version",
				},
			},
		},
		{
	...
	GoModNormalDeps = ftypes.Dependencies{
		{
			ID: "github.com/org/repo",
			DependsOn: []string{
				"github.com/khulnasoft-lab/go-version@v0.0.0-20240603093900-cf8a8d29271d",
				"stdlib@v1.22.5",
			},
		},
	}
	...
	GoModReplacedDeps = ftypes.Dependencies{
		{
			ID: "github.com/org/repo",
			DependsOn: []string{
				"github.com/khulnasoft-lab/go-dep-parser@v0.0.0-20220406074731-71021a481237",
			},
		},
	}
	...
	GoModUnreplacedDeps = ftypes.Dependencies{
		{
			ID: "github.com/org/repo",
			DependsOn: []string{
				"github.com/khulnasoft-lab/go-dep-parser@v0.0.0-20211110174639-8257534ffed3",
			},
		},
	}
	...
	defaultGoDepParserDeps = ftypes.Dependencies{
		{
			ID: "github.com/org/repo",
			DependsOn: []string{
				"github.com/khulnasoft-lab/go-dep-parser@v0.0.0-20211224170007-df43bca6b6ff",
			},
		},
	}
