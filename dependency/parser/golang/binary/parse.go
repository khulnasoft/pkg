...
func (p *Parser) Parse(r xio.ReadSeekerAt) ([]ftypes.Package, []ftypes.Dependency, error) {
	...
	if info.Main.Path != "" {
		...
		// See https://go.khulnasoft.com/tunnel/issues/1837#issuecomment-1832523477.
...
// See more in https://go.khulnasoft.com/tunnel/issues/6702#issuecomment-2122271427
...
// e.g.
//   - `go.khulnasoft.com/pkg/version/app.ver` => `version`
//   - `github.com/google/go-containerregistry/cmd/crane/common.ver` => `common`
func versionPrefix(s string) string {
	// Trim module part.
	// e.g. `go.khulnasoft.com/pkg/Version.version` => `Version.version`
