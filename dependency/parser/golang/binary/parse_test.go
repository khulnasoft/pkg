...
import (
	...
	"go.khulnasoft.com/pkg/dependency/parser/golang/binary"
...
func TestParse(t *testing.T) {
	wantPkgs := []ftypes.Package{
		{
			ID:           "github.com/khulnasoft-lab/test",
			Name:         "github.com/khulnasoft-lab/test",
			Version:      "",
		...
		{
			ID:      "github.com/khulnasoft-lab/go-version@v0.0.0-20210121072130-637058cfe492",
			Name:    "github.com/khulnasoft-lab/go-version",
	...
	wantDeps := []ftypes.Dependency{
		{
			...
			DependsOn: []string{
				...
				"github.com/khulnasoft-lab/go-version@v0.0.0-20210121072130-637058cfe492",
	...
	tests := []struct {
		...
		},
		{
			...
			wantPkgs: []ftypes.Package{
				{
					ID:           "github.com/khulnasoft-lab/test@v1.0.0",
					Name:         "github.com/khulnasoft-lab/test",
					Version:      "v1.0.0",
					Relationship: ftypes.RelationshipRoot,
				},
...
func TestParser_ParseLDFlags(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				name: "go.khulnasoft.com/tunnel",
				flags: []string{
					"-s",
					"-w",
					"-X=foo=bar",
					"-X='go.khulnasoft.com/pkg/version/app.ver=v0.50.1'",
				},
			},
			want: "v0.50.1",
		},
		{
			...
			args: args{
				...
				flags: []string{
					...
					"-w",
					"-X=foo=bar",
					"-X='go.khulnasoft.com/pkg/version.Version=v0.50.1'",
				},
			},
			want: "v0.50.1",
		},
		...
		},
		{
			...
			args: args{
				...
				flags: []string{
					...
					"-w",
					"-X=foo=bar",
					"-X='go.khulnasoft.com/pkg/version.Ver=v0.50.1'",
				},
			},
			want: "v0.50.1",
		},
		{
			...
			args: args{
				...
				flags: []string{
					...
					"-w",
					"-X=foo=bar",
					"-X=\"go.khulnasoft.com/pkg/version.Ver=0.50.1\"",
				},
			},
			want: "0.50.1",
		},
		...
		},
		{
			...
			args: args{
				name: "go.khulnasoft.com/tunnel",
				flags: []string{
					"-X='go.khulnasoft.com/tunnel/cmd/Any.Ver=0.50.0'",
					"-X='go.khulnasoft.com/pkg/version.Ver=0.50.1'",
				},
			},
			want: "0.50.0",
		...
		},
		{
			...
			args: args{
				...
				flags: []string{
					"-X='go.khulnasoft.com/tunnel/cmd/Any.Ver=0.50.0'",
					"-X='go.khulnasoft.com/pkg/Any.Ver=0.50.1'",
				},
			},
			want: "0.50.0",
		},
		{
			...
			args: args{
				name: "go.khulnasoft.com/tunnel",
				flags: []string{
					"-X='go.khulnasoft.com/pkg/Common.Ver=0.50.1'",
				},
			},
			want: "0.50.1",
		},
		{
			...
			args: args{
				name: "go.khulnasoft.com/tunnel",
				flags: []string{
					"-X='go.khulnasoft.com/pkg/Any.Ver=0.50.0'",
					"-X='go.khulnasoft.com/pkg/Common.Ver=0.50.1'",
				},
			},
			want: "0.50.1",
		...
		},
		{
			...
			args: args{
				name: "go.khulnasoft.com/tunnel",
				flags: []string{
					"-X='go.khulnasoft.com/pkg/Common.Ver=0.50.0'",
					"-X='go.khulnasoft.com/pkg/Main.Ver=0.50.1'",
				},
			},
			want: "",
		},
		{
			...
			args: args{
				...
				flags: []string{
					"-X='go.khulnasoft.com/pkg/Any.Ver=0.50.1'",
					"-X='go.khulnasoft.com/pkg/Any-pref.Ver=0.50.0'",
				},
			},
			want: "",
		},
