...
var (
	...
	// cd repo
	// go mod init github.com/org/repo
	// go get go.khulnasoft.com/tunnel
	// go list -m all | awk 'NR>1 {sub(/^v/, "", $2); printf("{\""$1"\", \""$2"\", },\n")}'
	GoModTunnel = []ftypes.Package{
		...
		{Name: "github.com/khulnasoft-lab/fanal", Version: "v0.0.0-20210119051230-28c249da7cfd"},
		{Name: "github.com/khulnasoft-lab/go-dep-parser", Version: "v0.0.0-20201028043324-889d4a92b8e0"},
		...
		{Name: "github.com/khulnasoft-lab/go-version", Version: "v0.0.0-20210121072130-637058cfe492"},
		{Name: "github.com/khulnasoft-lab/testdocker", Version: "v0.0.0-20210106133225-0b17fe083674"},
		{Name: "go.khulnasoft.com/tunnel", Version: "v0.16.0"},
		{Name: "go.khulnasoft.com/tunnel-db", Version: "v0.0.0-20210105160501-c5bf4e153277"},
		{Name: "github.com/khulnasoft-lab/vuln-list-update", Version: "v0.0.0-20191016075347-3d158c2bf9a2"},
